                                                                                  ...
                                                                                  <div class="card-body">
                                                                                      ...
                                                                                      <div
                                                                                          ...
                                                                                          <div class="form-actions center"
                                                                                              align="center">
                                                                                              <a href="./accept.php"><button type="button"
                                                                                                  class="btn btn-success  round btn-min-width mr-1 mb-1"
                                                                                                  id="submit"
                                                                                                  name="submit"
                                                                                                  onclick="insertOrganizationGroupType()">อนุมัติ</button></a>
                                                                                                  <a href="./not_accept.php"> <button type="button"
                                                                                                  class="btn btn-danger  round btn-min-width mr-1 mb-1"
                                                                                                  id="type-error">ไม่อนุมัติ</button></a>
                                                                                          </div>
                                                                                      </div>
