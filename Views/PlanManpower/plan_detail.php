                  ...
                  <div class="card-body card-dashboard">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 text-right">
                        <button class="btn round btn1 btncustom1"  data-toggle="modal" data-target="#bootstrap">  <i class="la la-calendar"></i> <span >  เปิด/ปิด รับสมัคร </span> </button>
                      </div>
                    </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header bg_custom1">
            <h5 class="modal-title" id="modalSettingRegis"> บันทึก/แก้ไข วันเวลาเปิด/ปิด รับสมัคร</h5>
