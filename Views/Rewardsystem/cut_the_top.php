          ...
          <div class="content-wrapper">
                                            <div class="content-header row">
                                                <div class="content-header-left col-12 mb-2">
                                                    ...
                                                    <h3 class="content-header-title">ข้อมูลบำเหน็จจากต้นสังกัด (ตัดยอด)</h3>
                                                                        <nav aria-label="breadcrumb">
                                                                            <ol class="breadcrumb">
                                                                                <li class="breadcrumb-item"><a
                                                                                        href="../home/index.php">ระบบบำเหน็จประจำปี</a></li>
                                                                                <li class="breadcrumb-item active" aria-current="page">
                                                                                บันทึก/แก้ไข ข้อมูลบำเหน็จจากต้นสังกัด (ตัดยอด)</li>
                                                                            </ol>
                                                                        </nav>
                                                </div>
                                            </div>
    ...
    <table class="table table-striped table-border table-hover">
        <thead>
            <tr class="justify-content-center"style="background-color:#0f1733; color:whitesmoke;">
                                              ...
                                              <tbody align="center">
                                                <tr>
                                                      <td class="bs-callout-danger callout-border-left callout-transparent mt-1 p-1"><input type="checkbox" class="checkAll" /></td>
                                                      <td>
                                                      ...
                                                      <select class="form-control" id="exampleFormControlSelect1">
                                                            <option>รอผลการศึกษา</option>
                                                            <option>พักราชการ</option>
                                                        </select>
                                                      </td>
                                                      <td>
