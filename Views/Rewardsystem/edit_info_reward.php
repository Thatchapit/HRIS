          ...
          <div class="content-wrapper">
                                            <div class="content-header row">
                                                <div class="content-header-left col-12 mb-2">
                                                    ...
                                                    <h3 class="content-header-title">รายชื่อข้าราชการที่ต้องการปรับปรุงข้อมูล</h3>
                                                                        <nav aria-label="breadcrumb">
                                                                            <ol class="breadcrumb">
                                                                                <li class="breadcrumb-item"><a
                                                                                        href="../home/index.php">ระบบบำเหน็จประจำปี</a></li>
                                                                                <li class="breadcrumb-item active" aria-current="page">
                                                                                ปรับแก้ข้อมูลบำเหน็จ</li>
                                                                            </ol>
                                                                        </nav>
                                                </div>
                                            </div>
...
<div class="shadow p-0 bg-white rounded">
    ...
    <div class="card collapse-icon accordion-icon-rotate active">
        ...
        <h6 style="background-color:#0f1733;color:white;line-height:40px;padding-left:10px;">ค้นหา รายชื่อข้าราชการที่ต้องการปรับปรุงข้อมูล</h6></a></div>
...
<div class="row">
        <div class="col-10 m-auto"> 
                ...
                <div class="form-row px-2">
                        ...
                        <div class="col-12">
                             <h5>ข้อมูลที่ปรับปรุง</h5>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                <label class="form-check-label" for="inlineRadio1">สังกัด</label>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio2">ชั้นยศ</label>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio3">ขั้นเงินเดือน</label>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="inlineRadio4">บุคคลที่สูญเสีย</label>
                            </div>
