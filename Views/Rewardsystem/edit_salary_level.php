  ...
  <?php 
    ...
    $id = $_GET['id'];
    $data = $reward_system->get_salary_level_by_id($id);
    if(count($data) == 0){
        echo '<meta http-equiv="refresh" content="0;url=set_salary_level.php">';
    }
                                  ...
                                  <div class="col-10 m-auto pt-3">
                                      <div class="form-row px-2 m-auto">
                                          ...
                                          <div class="form-group col-md-3">
                                              ...
                                              <input type="text" class="form-control" name="code" id=""
                                                  aria-describedby="helpId" placeholder="ระบุรหัสระดับ" value="<?= $data['code'] ?>">
                                          </div>
                                          ...
                                          <div class="form-group col-md-3">
                                              ...
                                              <select class="form-control" name="level" id="exampleFormControlSelect1">
                                                  ...
                                                  foreach ($dropdown_sal_level_code as $key => $value) {
                                                    $select_code = "";
                                                      if($value['SAL_LEVEL_CODE'] == $data['level_id']){
                                                          $select_code = "selected";
                                                      }
                                                    echo "<option ".$select_code." value='".$value['SAL_LEVEL_CODE']."'>".$value['SAL_LEVEL_NAME']."</option>";
                                                    }
                                                  ?>
                                              </select>
                                          </div>
                                              ...
                                              <select class="form-control" name="type" id="exampleFormControlSelect1">
                                                  <?php 
                                                    foreach ($dropdown_person as $key => $value) {
                                                        $select_person = "";
                                                      if($value['PERSON_TYPE_PK'] == $data['type_id']){
                                                          $select_person = "selected";
                                                      }

                                                        echo "<option ".$select_person." value='".$value['PERSON_TYPE_PK']."'>".$value['PERSON_TYPE_NAME']."</option>";
                                                    }
                                          ...
                                          <div class="col-12">
                                              <input type="checkbox" id="switch" <?= $data['status'] == 1 ? "checked" : "" ?> data-toggle="toggle" data-style="ios"
                                      ...
                                      <div class="row mt-2 pb-3">
                                          <div class="col-12 d-flex justify-content-center">
                                              <button type="button" onclick="updateSalaryLevel()"
