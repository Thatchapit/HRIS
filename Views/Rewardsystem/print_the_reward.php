          ...
          <div class="content-wrapper">
                                            <div class="content-header row">
                                                <div class="content-header-left col-12 mb-2">
                                                    ...
                                                    <h3 class="content-header-title">การพิมพ์รายงานสรุปยอดบําเหน็จ</h3>
                                                                        <nav aria-label="breadcrumb">
                                                                            <ol class="breadcrumb">
                                                                                <li class="breadcrumb-item"><a
                                                                                        href="../home/index.php">ระบบบำเหน็จประจำปี</a></li>
                                                                                <li class="breadcrumb-item active" aria-current="page">
                                                                                รายงานสรุปผลของแผนกบำเหน็จและสิทธิ กองการปกครอง</li>
                                                                            </ol>
                                                                        </nav>
                                                </div>
                                            </div>
...
<div class="shadow p-0 bg-white rounded">
    ...
    <div class="card collapse-icon accordion-icon-rotate active">
        ...
        <h6 style="background-color:#0f1733;color:white;line-height:40px;padding-left:10px;">ค้นหา การพิมพ์รายงานสรุปยอดบําเหน็จ</h6></a></div>
...
<div class="form-row px-2">
            ...
            <h5>ประเภทของรายงานสรุปยอดบำเหน็จประจำปี</h5>

            <div class="form-check">
                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked>
                    <label class="form-check-label" for="exampleRadios1">
                    รายงานสรุปยอดบำเหน็จทั้งหมด
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
                    <label class="form-check-label" for="exampleRadios2">
                    รายงานสรุปยอดบำเหน็จตามหน่วยงาน
                    </label>
                    </div>
                    ...
                    <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
                    <label class="form-check-label" for="exampleRadios3">
                    รายงานสรุปยอดเงินบำเหน็จตามหน่วยงาน
                    </label>
                    </div>
