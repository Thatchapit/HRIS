...
<div class="shadow p-0 bg-white rounded">
    <div class="card collapse-icon accordion-icon-rotate active">
        ...
        <h6 style="background-color:#0f1733;color:white;line-height:40px;padding-left:10px;">บันทึก แก้ไข ระดับชั้นของเงินเดือน</h6></a></div>
...
<div class="row">
        <div class="col-10 m-auto"> 
            <div class="form-row px-2 m-auto">
                    ...
                    <div class="form-group col-md-3">
                            <label for="formGroupExampleInput2">ชื่อระดับ:</label>
                            <select class="form-control" id="exampleFormControlSelect1" >
                                <option>น.1</option>
                                <option>น.2</option>
                            </select>
                    ...
                    <div class="form-group col-md-3">
                                    <label for="formGroupExampleInput">ชั้น:</label>
                    ...
                    <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"  placeholder="30,000">
                    </div>


                    <div class="form-group col-md-3">
                                    <label for="formGroupExampleInput">เงินเดือนต่ำ:</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"  placeholder="0.5">
                    </div>

                    <div class="form-group col-md-3">
                                    <label for="formGroupExampleInput">เงินเดือนสูงสุด:</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"  placeholder="30,000">
                    </div>


                    <div class="form-group col-md-3">
                            <label for="formGroupExampleInput2">ระดับของเงินเดือนใหม่:</label>
                            <select class="form-control" id="exampleFormControlSelect1" >
                                <option>สัญญาบัตร</option>
                                <option>ประทวน</option>
                            </select>
                    ...
                    <div class="form-group col-md-3">
                                    <label for="formGroupExampleInput">ขั้นของเงินเดือนใหม่:</label>
